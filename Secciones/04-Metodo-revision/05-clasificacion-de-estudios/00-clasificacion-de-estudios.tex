...
\begin{table*}[htbp]
	...
	\begin{tabularx}{\textwidth}{p{0.8cm}p{2.0cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}Xp{0.8cm}p{0.8cm}>{\raggedright\arraybackslash}X}
		\toprule
		\textbf{RQ}                          & \textbf{Topic}   & \textbf{2020-2022}                          & \textbf{2023-2024}                         	& \textbf{2025-2026}                                         \\
		\midrule
