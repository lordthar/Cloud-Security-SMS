...
\begin{table*}[htbp]
	...
	\begin{tabularx}{\textwidth}{p{0.5cm}p{2.5cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X}
		\toprule
		\textbf{RQ}                           & \textbf{Topic}          & \textbf{2020-2022}                          & \textbf{2023-2024}                         	& \textbf{2025-2026}  						\\
		\midrule
		\multirow{8}{*}[-10em]{\textbf{RQ1}} & CLOUD COMPUTING 		& SPS017 SPS019 SPS023 SPS034 SPS055 SPS080	
