...
\subsubsection{Estrategia de Busqueda 2: Bola de nieve}
...
A diferencia de otros estudios que utilizan un conjunto reducido de artículos iniciales para iniciar el proceso de \textit{snowballing}, 
en este trabajo se aplicó la estrategia sobre la totalidad de los estudios resultantes del proceso de selección en bases de datos, 
correspondiente a 166 artículos. De esta manera, cada uno de los estudios incluidos fue analizado tanto en sus referencias como en sus 
citas, permitiendo ampliar la cobertura de la revisión y disminuir el riesgo de omitir literatura relevante.
...
citadas dentro del artículo (bola de nieve inversa) como los trabajos que citan dicho estudio (bola de nieve directa). 
Para la identificación de las relaciones de citación entre publicaciones se utilizó Google Académico.
