...
un análisis de frecuencia para identificar el cuartil de estudios más significativos, es decir, aquellos con los valores más altos 
del índice CVI.\@ La formula se puede ver completa en la sección~\ref{subsec:criterios_calidad}, se muestra la ecuación~\ref{eq:cvi}.
