...
Tras aplicar los procedimientos de búsqueda y selección de estudios, así como su evaluación de calidad, se muestran los estudios primarios 
de \totalEtapaDos{}. Estos estudios se etiquetaron con el prefijo SPS (Estudio Primario Seleccionado) seguido de un número. La lista 
completa de estos estudios se puede encontrar en la Tabla~\ref{table:selected_primary_studies}. A partir de los SPS de \totalEtapaDos{}, 
se diseño una taxonomía para completar uno de los objetivos planteados al inicio del SMS.\@ La información contenida en los SPS se 
relacionó con las preguntas de investigación a través de los temas definidos en la etapa de planificación y se registró utilizando los 
modelos GQM y PICOC.\@ Además, se extrajeron metadatos, como palabras clave, para identificar los aspectos subyacentes de los SPS.\@
...
bibliográficas como Mendeley y SMS-Builder~\cite{Candela-Uribe2022} para la construcción del análisis de datos. Toda la información de 
este SMS se ha publicado en el sitio%~\cite{sms-builder-own-container} 
y los métodos de acceso se describen en la sección~\ref{sec:reproducibilidad}.