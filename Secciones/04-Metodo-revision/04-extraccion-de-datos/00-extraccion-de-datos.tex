...
\begin{table*}[htbp]
	...
	\begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} r l @{\extracolsep{\fill}} r l @{\extracolsep{\fill}} r l @{\extracolsep{\fill}} r l @{\extracolsep{\fill}} r}
		...
		SPS061      &~\cite{Sharma2023APT}         			& SPS062      &~\cite{Ouhssini2024DDoSCloudReview}      	& SPS063      &~\cite{Mallidi2025AIIDSIoT}      			& SPS064      &~\cite{Hussain2025WSNIDS}         			 & SPS065      &~\cite{Ray2023DDoSMHealth}         		 \\
		...
		SPS086      &~\cite{Aldweesh2020DeepLearningIDS}    & SPS087      &~\cite{Radoglou2022IIoTSecurity}      		& SPS088      &~\cite{Wang2022eBPFIDS}         				& SPS089      &~\cite{Kirubavathi2025TransformerDDoS}      	 & SPS090      &~\cite{Doğan2025SDNIDSReview}         	 \\
		...
		SPS121      &~\cite{Buyuktanir2025FederatedIDS}		& SPS122      &~\cite{Srinivasan2025FederatedCryptography}  & SPS123      &~\cite{Galle2025CyberResilienceBoard}        & SPS124      &~\cite{Du2025CostSensitiveTraffic}      		 & SPS125      &~\cite{Alotaibi2025HRLDeepNet}        	 \\
